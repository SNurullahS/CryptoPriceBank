...
class CryptoAdapter(var cryptoList :ArrayList<CryptoModel>, private val listener: Listener) : RecyclerView.Adapter<CryptoViewHolder>() {

    private  val colors : Array<String> = arrayOf("#CD5C5C","#2980b9","#1abc9c","#b7950b","#e67e22","#922b21","#34495e","#6c3483")
